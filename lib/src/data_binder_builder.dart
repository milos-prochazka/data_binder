...
const voidWidget = SizedBox.shrink(); // TODO zavest pouzivani voidWidget vsude kde je treba
...
Widget buildCupertinoButtonFilled
(
  BuildContext context,
  {required String bindValue,
    Key? key,
...
Widget buildElevatedButtonIcon
(
  BuildContext context,
  {required String bindValue,
    Key? key,
...
Widget buildOutlinedButtonIcon
(
  BuildContext context,
  {required String bindValue,
    Key? key,
...
Widget buildBasicRadioColumn<T>
(
  BuildContext context,
  {required String bindValue,
    dynamic bindValueParam,
...
Widget buildCupertinoTextFieldBorderless
(
  BuildContext context,
  {required String bindValue,
    dynamic bindValueParam,
  ...
  (
    ...
    builder: (context, value, child)
    {
      ...
      (
        ...
        (
          enableEvent
          ? (newValue) => value.doEvent(context: context, event: StdValueProperty.onChangeStart, parameter: (newValue))
          : null
        ),
        onChangeEnd:
        (
...
CupertinoActionSheetAction buildCupertinoActionSheetAction
(
  BuildContext context,
  {required String bindValue,
...
)
{
  ...
  (
    key: value.setKey(key),
    onPressed: () => value.doEvent(context: popupContext, event: StdValueProperty.onPressed, parameter: eventParameter),
...
CupertinoDialogAction buildCupertinoDialogAction
(
  BuildContext context,
  {required String bindValue,
    required BuildContext popupContext,
...
Widget buildCircularProgressIndicatorAdaptive
(
  BuildContext context,
  {required String bindValue,
    dynamic bindValueParam,
...
Widget buildOffstage(BuildContext context,
...
Widget buildTickerMode(BuildContext context,
